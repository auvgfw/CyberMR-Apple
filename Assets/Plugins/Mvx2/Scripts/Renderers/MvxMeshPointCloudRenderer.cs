...
namespace MVXUnity
{
    ...
    public class MvxMeshPointCloudRenderer : MvxMeshRenderer
    {
        ...
        protected override UInt32 GetFrameMeshIndicesCount(MVGraphAPI.MeshData meshData)
        {
            return meshData.GetNumVertices();
        }

        unsafe protected override void CopyMeshIndicesToCollection(MVGraphAPI.MeshData meshData, Int32[] meshPartIndices)
        {
        ...
        protected override MVGraphAPI.MeshIndicesMode GetFrameIndicesMode(MVGraphAPI.MeshData meshData)
        {
            return MVGraphAPI.MeshIndicesMode.MIM_PointList;
        }
