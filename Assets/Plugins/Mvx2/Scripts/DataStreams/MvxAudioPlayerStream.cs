...
namespace MVXUnity
{
    ...
    public class MvxAudioPlayerStream : MvxDataReaderStream
    {
        ...
        {
            PLAYBACKMODE_FORWARD_ONCE = MVGraphAPI.RunnerPlaybackMode.RPM_FORWARD_ONCE,
            PLAYBACKMODE_FORWARD_LOOP = MVGraphAPI.RunnerPlaybackMode.RPM_FORWARD_LOOP,
            PLAYBACKMODE_REALTIME = MVGraphAPI.RunnerPlaybackMode.RPM_REALTIME
        }
        ...
        private MVGraphAPI.RunnerPlaybackMode mvxPlaybackMode
        {
            get { return (MVGraphAPI.RunnerPlaybackMode)m_playbackMode; }
        }
        ...
        [System.NonSerialized] private MVGraphAPI.ManualSequentialGraphRunner m_mvxRunner = null;
        ...
        public override void SeekFrame(uint frameID)
        {
            ...
            lock (m_audioChunkFramesQueue)
            {
                ...
                {
                    KeyValuePair<MvxAudioChunk, MVCommon.SharedRef<MVGraphAPI.Frame>> dequeuedAudioChunkFrame = m_audioChunkFramesQueue.Dequeue();
        ...
        private Queue<KeyValuePair<MvxAudioChunk, MVCommon.SharedRef<MVGraphAPI.Frame>>> m_audioChunkFramesQueue = new Queue<KeyValuePair<MvxAudioChunk, MVCommon.SharedRef<MVGraphAPI.Frame>>>();
