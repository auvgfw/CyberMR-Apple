...
namespace MVXUnity
{
    ...
    public class MvxCustomDataStreamDefinition : MvxDataStreamDefinition
    {
        ...
        public override MVGraphAPI.GraphNode GetSourceGraphNode()
        {
            MVGraphAPI.SingleFilterGraphNode singleFilterGraphNode = new MVGraphAPI.SingleFilterGraphNode(MVCommon.Guid.FromHexString(sourceFilterGUID));
