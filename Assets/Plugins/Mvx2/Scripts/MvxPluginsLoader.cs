...
namespace MVXUnity
{
    public static class MvxPluginsLoader
    {
        ...
        public static void LoadPlugins()
        {
            ...
            MVGraphAPI.PluginsLoader.LoadPluginsInFolder(pluginsDirectory, false, false);
#endif
        ...
        {
            return Path.Combine(MvxGlobal.pluginLocation, "plugins", "x64");
        }
#endif
        ...
        {
            return Path.Combine(MvxGlobal.pluginLocation, "plugins/macos_unity");
        }
#endif
        ...
        {
            return MVGraphAPI.Utils.GetAppExeDirectory().NetString;
        }
#endif
    }
}
